...
if __name__ == '__main__':
    ...
    parser.add_argument('-l', '--levels', type=int, nargs='+', default=[0, 1, 2], help='Levels to extract')
    ...
    parser.add_argument('-th', '--threshold', type=float, default=15, help='Threshold for filtering background')
    parser.add_argument('-w', '--workers', type=int, default=10, help='Number of worker processes')
